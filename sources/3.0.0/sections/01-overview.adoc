...
With our Metanorma training today, we are all learning a lot.
...
Position described by a single set of {{Coordinate,coordinates}} within a *coordinate reference system*.
